...
from services.common import ensure_limit, require_board_codes, require_board_money_flow_scope, require_board_quote_freq
...
def get_quotes(
    ...
    return _QUOTEMUX.boards.get_quotes(
        require_board_codes(board_code, board_codes),
