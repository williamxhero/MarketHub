...
SCHEMA_SQL = (
    ...
    create table if not exists ref.etf (
        ...
        fund_type character varying not null default '',
        management character varying not null default '',
        custodian character varying not null default '',
        listed_date date,
        delisted_date date,
    ...
    """,
    "create index if not exists etf_daily_1d_trade_date_idx on fact.etf_daily_1d (trade_date)",
